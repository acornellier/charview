    ...
    for (var f in WH.statToJson) {
      ...
      if (c[C] || (c.statsInfo && c.statsInfo[f])) {
        ...
        if (C == 'sta') {
          ...
          c[C] =
            c[C] * WH.getCombatRatingMult(c.level, c.slot || g_items[c.id].slot)
...
WH.setTooltipSpells = function (e, t, a, i, n = 0) {
  ...
  for (var b = 0; b < p.length; ++b) {
    var y = p[b].match(I)[2]
    var _ = WH.inArray(t, parseInt(y)) >= 0 ? 1 : 0
    if (a[y] == null) {
      continue
    }
    if (i[y] == null) {
...
WH.enhanceTooltip = function (e, t, a, i, n, s, r, o, l, c, d, f, u) {
  ...
  if (i && Slider) {
    ...
    if (n) {
      ...
      if (typeof A == 'undefined' && W == 3) {
        w = new RegExp('\x3c!--\\?(\\d+):(\\d+):(\\d+):(\\d+)')
        A = e.match(w)
      }
      if (!A && !WH.isRetailTree()) {
        w = new RegExp('\x3c!--ppl(\\d+):(\\d+):(\\d+):(\\d+):(\\d+)')
        var L = e.match(w)
        if (L) {
  ...
  if (c) {
    ...
    if (L) {
      ...
      if (this._rppmModList.hasOwnProperty(1)) {
        x += ' + ' + WH.Wow.Item.Stat.jsonToAbbr('hastertng')
      } else if (this._rppmModList.hasOwnProperty(2)) {
        x += ' + ' + WH.Wow.Item.Stat.jsonToAbbr('critstrkrtng')
      }
      ...
      if (x.length > 0) {
        e = e.replace(
          /<!--rppm-->\[?(\d+(?:\.\d+)?)([^<]*)<!--rppm-->/,
          function (e, t, a) {
            return '\x3c!--rppm--\x3e[' + t + x + ']' + a + '\x3c!--rppm--\x3e'
          },
        )
      }
    }
  ...
  if (W == 3) {
    ...
    if (F && WH.Wow.Item.tooltipHasSpecStats(e)) {
      ...
      var G = /(&|\?)class=(\d+)/.exec(location.href)
      if (G) {
        B = { classId: parseInt(G[2]), specId: 0 }
      }
      var q = /(&|\?)spec=(\d+)/.exec(location.href)
      var z, j
      if (q) {
        z = parseInt(q[2])
        ...
        fields: [
          {
            ...
            compute: function (e, a, i, n) {
              ...
              s.update = function () {
                ...
                WH.ae(
                  s,
                  WH.Icon.create(e.value, WH.Icon.LARGE, undefined, {
                    game: t,
                  }),
                )
              }
              WH.ae(s, WH.Icon.create(a, WH.Icon.LARGE, undefined, { game: t }))
              WH.ae(n, s)
              WH.ae(n, e)
            },
          },
  ...
  new (function () {
    ...
    this.register = function (t, a, n, s, r) {
      ...
      }
      {
        if (!st.isLoaded(t, n)) {
          o.status = F
          st.registerCallback(t, n, e.register.bind(this, t, a, n, s, r))
          return
        }
        if (
          typeof a === 'string' &&
          (a.indexOf('lvl') === 0 || a.match(/[^i]lvl/)) &&
          !st.isLoaded(i.SPELL, n)
        ) {
          o.status = F
          st.registerCallback(i.SPELL, n, e.register.bind(this, t, a, n, s, r))
          return
        }
      }
      if (o.timer) {
    ...
    if (!WH.REMOTE) {
      ...
      this.getScalingData = (e, t) => st.getDataByKey(e, t)
    ...
    function be() {
      if (WH.REMOTE) {
        ...
        V()
        Me(function () {
          st.fetch(i.ITEM, WH.getDataEnv())
          st.fetch(i.SPELL, WH.getDataEnv())
        })
      }
    }
    function ye() {
    ...
    function ze(a, n, r) {
      ...
      l.replace(y, (e, t, a) => Pe(W, t, a) || '')
      if (o) {
        o.replace(y, (e, t, a) => Pe(W, t, a) || '')
      }
      ...
      if (
        l.indexOf('#') !== -1 &&
        document.location.href.indexOf(w + '=' + A) !== -1
      ) {
        return N
      }
      $.show.mode = H
      ...
      if (!WH.REMOTE && !a.whContextMenuAttached) {
        ...
        WH.aE(a, 'contextmenu', Ce.bind(a, J, X, x, w, A, W, P))
      }
      if (n) {
      ...
      if ((re || me('iconizeLinks')) && d.includes(x)) {
        if (!re) {
          re = me('iconSize')
        }
        se.push(function () {
    ...
    function Qe(e, t, a, i) {
      ...
      Ye(i)
      $e(t, i.finalContent2, i.image, i.imageClass)
      Le(
    ...
    function Je(e, t, a, i) {
      ...
      if (a) {
        t = it(t, a)
        if (i.finalContent2) {
          i.finalContent2 = it(i.finalContent2, a)
        }
      }
      Fe(
        i.dataEnv,
    ...
    function Xe(e, t, a, i) {
      ...
      Ye(i)
      $e(e, i.finalContent2, i.image, i.imageClass)
    ...
    function Ze(e, t, a) {
      ...
      Ye(a)
      $e(t, a.finalContent2, a.image, a.imageClass)
      Le()
    }
    function et(t, a, i, n) {
      if (
      ...
      if (!s) {
        ...
        if (WH.reforgeStats && e.forg && WH.reforgeStats[e.forg]) {
          ...
          for (var w in WH.individualToGlobalStat) {
            if (WH.individualToGlobalStat[w] === _[0]) {
              _.push(w)
            }
          }
          var A
        ...
        if (e.pcs && e.pcs.length) {
          var C = 0
          for (var w = 0, M = e.pcs.length; w < M; ++w) {
            var A
            var N = new RegExp(
              '<span>\x3c!--si([0-9]+:)*' +
                e.pcs[w] +
        ...
        if ($.show.type === i.ACHIEVEMENT && e.cri) {
          for (var w = 0; w < e.cri.length; w++) {
            s = s.replace(
              new RegExp('\x3c!--cr' + parseInt(e.cri[w]) + ':[^<]+', 'g'),
              '<span class="q2">$&</span>',
            )
          }
        }
        ...
        if (a) {
          for (var F in g_user.lists) {
            ...
            P +=
              ...
              '"></span> '
            P += U.character + ' - ' + U.realm + ' ' + U.region
          }
        }
          ...
          ;(g_user.lists || []).forEach(function (e) {
            ...
            if (t > 0) {
              P +=
                ...
                '"></span> '
              P += e.character + ' - ' + e.realm + ' ' + e.region
            }
          })
        }
        if (P !== '') {
          s += '<br><span class="q">' + WH.TERMS.completion + ':</span>' + P
        }
      }
      if (
        !WH.REMOTE &&
    ...
    function at() {
      ...
      if (G.includes($.show.type) && !t.data[Te()]) {
        Oe()
        return
      }
